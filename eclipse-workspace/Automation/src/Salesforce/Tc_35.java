...
password.sendKeys("test@123");
	...
	//WebElement tabs = driver.findElement(By.xpath("//img[contains(@class,'allTabsArrow')]"));
	//tabs.click();
	
	WebElement customize = driver.findElement(By.xpath("//input[contains(@name,'customize')]"));
	customize.click();
	
	WebElement remove = driver.findElement(By.xpath("//div[contains(@class,'duelingText')]"));
	remove.click();
